<!-- FORMULARIO DE NUEVA DE MATERIA -->
<?php
            ...
            <div class="col d-flex justify-content-end pt-4">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active text-dark" aria-current="page">Nueva Materia</li>                    </ol>
                </nav>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    ...
                    <form action=<?= "$URL/nueva_materia/" ?> method="POST" class="col-12" id="formNuevaMateria">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="inputNombre" name="nombre" aria-describedby="nombreHelp" placeholder="Ingresar nombre de la materia">
